...
def process_image(img, dist_pickle, src, dst, thresholds, tracker):
    mtx = dist_pickle["mtx"]
    ...
    result = pipeline(image, thresholds['l_thresh'], thresholds['b_thresh'], thresholds['grad_thresh'], thresholds['dir_thresh'])
